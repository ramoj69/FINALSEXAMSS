...
<!-- SEARCH BAR -->
	...
	<div class="searchForm" style='text-align: left; margin-left: flex;'>
		<form action="index.php" method="GET">
			<p>
				<input type="text" id="searchbox" name="searchInput" placeholder="Search here">
			...
			<?php if (!isset($_GET['searchBtn'])) { ?>
				...
				<tr>
                    ...
                    <td>    
                        ...
                        <a href="update_status.php?branch_id=<?php echo $row['branch_id']; ?>&status=accepted" 
                        style="color: green;">Accept</a>
                        <a href="update_status.php?branch_id=<?php echo $row['branch_id']; ?>&status=declined" 
                        style="color: red;">Decline</a>
					</td>
				</tr>
				<?php } ?>
			<?php } else { ?>
